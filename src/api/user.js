...
import { authorizationClient } from "../components/signup/api";
import toastMsg from "../ui/Toast";
// import { IUser } from "../interface/user"; // typescript 아닌 순수 js에서는 인터페이스 사용 못함
import API from "../components/signup/api/config";
...
const changeProfile = createAsyncThunk(
    "user/changeProfile",
    async ({ image, id }, { rejectWithValue }) => {
        try {
            const response = await authorizationClient.patch(
